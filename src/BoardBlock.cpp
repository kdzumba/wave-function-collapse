 ...
 * only options that were available for that block after collapse
...
//    if(std::find(m_remaining_options.begin(), m_remaining_options.end(), option) == m_remaining_options.end())
